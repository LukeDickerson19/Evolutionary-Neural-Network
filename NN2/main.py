...
class PyGameView(object):
    ...
    def draw_simulation(self):
        ...
        for food in self.model.foods:
            pygame.draw.circle(
                self.simulation_surface, food.color,
                food.int_center, int(food.radius))
...
class Model(object):
    ...
    def create_population(self, num_winners=2):
        ...
        for i in range(0, BOT_NUM):
            ...
            self.bots.append(Bot(self, data))
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if event.button == 4:
                    ...
                    and my < SCREEN_SIZE[1] and my > 0:
                        ...
                        for c in circles:
                            distance = np.sqrt((c.x - mx)**2 + (c.y - my)**2)
